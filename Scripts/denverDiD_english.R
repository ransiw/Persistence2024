...
#write.csv(attdf,file.path(didpath,paste0("English_","All_",obsname,"Denver.csv")))
...
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_Test3_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_Test4_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_Test5_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_Test6_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_Test7_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Denver_Test8_dynamic.csv")), row.names = FALSE)
