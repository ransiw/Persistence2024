...
#write.csv(attdf,file.path(didpath,paste0("English_","All_",obsname,"Rural.csv")))
...
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_Test3_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_Test4_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_Test5_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_Test6_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_Test7_dynamic.csv")), row.names = FALSE)
...
agtobject$overall.se
agtdynamic = aggite_table(agtobject)
write.csv(agtdynamic,file.path(didpath,paste0("English_","All_",obsname,"Rural_Test8_dynamic.csv")), row.names = FALSE)
